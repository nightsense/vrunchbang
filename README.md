...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:vrunchbang_dark_CursorLineNr = 'off'
...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:vrunchbang_dark_LineNr = 'off'
